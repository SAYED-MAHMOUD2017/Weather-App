...
function display() {
  ...
  <div class="col-lg-4" id="firstDay">
            <div class="first-day day rounded-top">
              ...
              <div class="content px-4 pb-4">
                  <h5 class="countryCity text-white fw-normal">${locationData.location.name} / ${locationData.location.country}</h5>
                <div class="deg d-flex mt-4">
                  <div class="deg-text">
                  <h2 class="degHot text-white fw-bold">${locationData.location.lat}<sup>o</sup>C</h2>
                  <h6 class="degHot text-white fw-bold">${locationData.location.lon}<sup>o</sup>C</h6>
                  </div>
                ...
                <div class="icons d-flex">
                  <span class="me-4 text-white-50"><img class="me-2" src="images/icon-umberella.png" alt="">${locationData.current.vis_km}%</span>
                  <span class="me-4 text-white-50"><img class="me-2" src="images/icon-wind.png" alt="">${locationData.current.wind_kph}km/h</span>
                  <span class="me-4 text-white-50"><img class="me-2" src="images/icon-compass.png" alt="">${locationData.current.wind_dir}</span>
                </div>
              </div>
            </div>
          </div>`
  ...
  document.getElementById("days").innerHTML += `
          <div class="col-lg-4">
            <div class="third-day day rounded-top text-center">
